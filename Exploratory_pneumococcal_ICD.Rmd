...
extracted fields 61-64, which includes Education 1989 revision field 1-2; education 2003 revision field 3, reporting flag field 4...need to parse this 
```{r}
unique(pneumo.deaths$education)

sum(substr(pneumo.deaths$education,1,1)== '9')/nrow(pneumo.deaths)
